...
def main(argv: list[str] | None = None) -> int:
    ...
    r.add_argument("--objective", default="Build a price prediction model for rental apartments in Switzerland, trained on apartment-level data (one row per individual rental listing, not aggregated statistics).")
    r.add_argument("--region", default="Switzerland")
